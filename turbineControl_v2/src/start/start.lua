...
function checkUpdates()
	...
	local currBranch = ""
	local tmpString = string.sub(version,7,7)
	...
	downloadFile("https://raw.githubusercontent.com/Feramance/Reactor-and-Turbine-control-program/"..currBranch.."/turbineControl_v2/src/",currBranch..".ver")
